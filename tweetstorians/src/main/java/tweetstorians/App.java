...
public class App {
	...
	public void listenStream(String consumerKey, String consumerSecret,
		...
		List<String> ang_cleaned = null; //FileUtils.fileToList(FileUtils.inputPath
				//+ "ang_cleaned.txt");
	...
	public void run(String consumerKey, String consumerSecret, String token,
			String secret) throws InterruptedException, TwitterException {
	    ...
	    //Status status = twitter.updateStatus("First test tweet from my tweetstorians app");
	    
	    Status status = twitter.updateStatus("[Automatic tweet] Will jemand auf dem #histocamp Tabellen twittern?");
